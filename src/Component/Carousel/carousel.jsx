...
export default function Carousel() {
    ...
    // 사용자 유형에 따른 슬라이드 데이터 선택
    const slidesData = user?.userType === 'vet' ? slidesData_vet : slidesData_regular;
    //슬라이드 데이터 개수(길이만큼)
...
const slidesData_vet = [
    { id: 1, title: "비대면 컨설팅으로 수익 창출", text: "병원 홍보까지 일석이조", linktext: "상담하러가기", img: "/img/bear.png", bk_color: "rgb(104, 23, 27)" },
